...
{
    class DeviceCommDataServiceHelper: PluginBase
    {
        #region init
        private IDataServer _DataServer = null;
        public DeviceCommDataServiceHelper()
        {
            try
            {
        ...
        #endregion
        #region Define
        private static DeviceCommDataServiceHelper _Instanse = null;
        /// <summary>
        /// 获取数据服务
        /// </summary>
        public static DeviceCommDataServiceHelper Instanse
        {
            get
            {
                if (_Instanse == null)
                    _Instanse = new DeviceCommDataServiceHelper();
                return _Instanse;
            }
        }
        #endregion
        ...
        public bool SaveCommunicationInfo(string comName,string portNumber=null,int baudRate=-1,int dataBit=-1,float stopBit=-1,int checkBit=-1,string IP=null,string portNumberTCP=null,string CSType=null)
        {
            ...
            if (CSType != null) dt.CSType.Value = CSType;
        ...
        public DTAirQualityInfo QueryAirQuality()
        {
            ...
            dt.ID.Orderby = 2;
            ArrayList rs = _DataServer.GetResult(dt,dt.ID.FieldName,1,1);
